<template>
  <v-container dark fill-height justify="center">
    <v-card dark color="#33333e">
      <v-card-text>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Genshin compact.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Genshin compact, accessible
              from
              <a
                href="http://www.genshin-compact.com"
                rel="external nofollow noopener"
                target="_blank"
                >http://www.genshin-compact.com</a
              >
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: genshincompactapp@gmail.com</li>
        </ul>
      </v-card-text>
    </v-card>
  </v-container>
